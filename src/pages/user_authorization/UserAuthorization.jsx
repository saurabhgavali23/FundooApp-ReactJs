            ...
            >
              <Grid item>
                <Card className="paper">
                  <CardContent className="headerText">price: $99 per month</CardContent>
                  ...
                  <div className="bulletPointdiv">
                    <div className="bulletPoint">{'\u2022'}</div>
                    <div className="priceTag">Ability to add title, 
                    description, images, labels, checklist and colors</div>
                  </div>
                </Card>
              </Grid>
              <Grid item>
                <Card className="paper">
                  <CardContent className="headerText">price: $49 per month</CardContent>
                  ...
                  <div className="bulletPointdiv">
                    <div className="bulletPoint">{'\u2022'}</div>
                    <div className="priceTag">Ability to add only title and description</div>
                  </div>
                </Card>
              </Grid>
            </Grid>
